...
## Overview
The UI layer of **RepeatKit** strictly adheres to the MVVM pattern with unidirectional data flow (UDF). ViewModels expose immutable `StateFlow<UiState<T>>` properties observed by Jetpack Compose composable screens.
