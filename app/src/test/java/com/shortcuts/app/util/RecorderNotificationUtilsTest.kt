...
class RecorderNotificationUtilsTest {
    ...
    @Test
    fun testFormatFinishedContentText() {
        assertEquals("Shortcut recorded — 1 step captured", RecorderNotificationPresenter.formatFinishedContentText(1))
        assertEquals("Shortcut recorded — 0 steps captured", RecorderNotificationPresenter.formatFinishedContentText(0))
        assertEquals("Shortcut recorded — 3 steps captured", RecorderNotificationPresenter.formatFinishedContentText(3))
    }
